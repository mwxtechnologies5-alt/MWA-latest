            ...
            <div className="space-y-8 text-foreground/80 font-body">
              <section className="p-6 rounded-xl bg-card/50 border border-[#8b5cf6]/10">
                ...
                <p className="text-foreground/70 leading-relaxed">
                  By accessing or using MWX Technologies&apos;s services, you
              ...
              <section className="p-6 rounded-xl bg-card/50 border border-[#8b5cf6]/10">
                ...
                <p className="text-foreground/70 leading-relaxed mb-4">
                  MWX Technologies provides digital marketing, web development,
                  mobile app development, and related technology services. Our
              ...
              <section className="p-6 rounded-xl bg-card/50 border border-[#8b5cf6]/10">
                ...
                <div className="space-y-4 text-foreground/70">
                  <p className="leading-relaxed">
                    Payment terms vary by service and will be specified in
                    individual service agreements. General terms include:
                  </p>
              ...
              <section className="p-6 rounded-xl bg-card/50 border border-[#8b5cf6]/10">
                ...
                <p className="text-foreground/70 leading-relaxed mb-4">
                  ...
                  as specified in their contract. MWX Technologies retains:
                </p>
                <ul className="list-disc list-inside space-y-2 text-foreground/70">
              ...
              <section className="p-6 rounded-xl bg-card/50 border border-[#8b5cf6]/10">
                ...
                <p className="text-foreground/70 leading-relaxed">
                  MWX Technologies shall not be liable for any indirect,
              ...
              <section className="p-6 rounded-xl bg-card/50 border border-[#8b5cf6]/10">
                ...
                <p className="text-foreground/70 leading-relaxed">
                  Either party may terminate services according to the terms
                  specified in individual service agreements. Upon termination,
                  clients are responsible for payment of all work completed to
                  date.
                </p>
              </section>
              ...
              <section className="p-6 rounded-xl bg-card/50 border border-[#8b5cf6]/10">
                ...
                <div className="mt-4 p-4 rounded-lg bg-[#8b5cf6]/5 border border-[#8b5cf6]/20">
                  ...
                  <p className="text-foreground/70">
                    Email: legal@MWXmedia.com
                  </p>
                  <p className="text-foreground/70">Address: Varanasi, India</p>
                </div>
              </section>
            </div>
          </motion.div>
