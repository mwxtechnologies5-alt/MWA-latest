...
function componentTagger(src, map) {
    ...
    try {
        ...
        /* 
         * Webpack expects the sourcemap as a plain object. 
         * Passing it directly if it's a class instance can sometimes cause it to 
         * be stringified incorrectly in modern Next.js build pipelines.
         */
        done(null, out, JSON.parse(outMap.toString()));
    }
    catch (err) {
        done(err);
    }
